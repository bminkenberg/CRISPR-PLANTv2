# 2-13-16 I try this script to make a FASTA directly from
# seqtable and no ID file and input FASTA necessary
    ...
    for line in f:
        ...
        if '.' in line:
            ...
            if '+' == line[2]:
                ...
                # set +3, add :c, and remove first three char from line[5]
                line[5] = line[5][:-3]
